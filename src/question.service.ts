...
export class QuestionService 
{
  ...
  getFirstQuestion(subject:string):Observable<Question>
  {
    ...
    return this.httpclient.get<Question>("http://localhost:7777/getFirstQuestion/"+subject);
  ...
  nextQuestion()
  {
    return this.httpclient.get<Question>("http://localhost:7777/nextQuestion");
  }


  previousQuestion()
  {
    return this.httpclient.get<Question>("http://localhost:7777/previousQuestion");
  }


  saveAnswer(answer:Answer)
  {
    return this.httpclient.post<void>("http://localhost:7777/saveAnswer",answer);
  }

  endexam()
  {
     return this.httpclient.get<number>("http://localhost:7777/endexam");
  }

  getAllAnswers()
  {
    return this.httpclient.get<Answer[]>("http://localhost:7777/getAllAnswers");
  }
}
